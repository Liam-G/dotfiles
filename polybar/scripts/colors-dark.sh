...
if  [[ $1 = "-custom" ]]; then
# Replacing colors
sed -i -e 's/bg = .*/bg = ${xrdb:background:#1F1F1F}/g' $PDIR/config.ini
sed -i -e 's/fg = .*/fg = #FFFFFF/g' $PDIR/config.ini
sed -i -e 's/fg-alt = .*/fg-alt = ${xrdb:foreground:#A9ABB0}/g' $PDIR/config.ini
sed -i -e 's/acolor = .*/acolor = #FFFFFF/g' $PDIR/config.ini
sed -i -e 's/txt = .*/txt = #2C2C2C/g' $PDIR/config.ini
sed -i -e 's/shade1 = .*/shade1 = ${xrdb:color2:#FF6F00}/g' $PDIR/config.ini
sed -i -e 's/shade2 = .*/shade2 = ${xrdb:color2:#FF8F00}/g' $PDIR/config.ini
sed -i -e 's/shade3 = .*/shade3 = ${xrdb:color2:#FFA000}/g' $PDIR/config.ini
sed -i -e 's/shade4 = .*/shade4 = ${xrdb:color2:#FFB300}/g' $PDIR/config.ini
sed -i -e 's/shade5 = .*/shade5 = ${xrdb:color2:#FFC107}/g' $PDIR/config.ini
sed -i -e 's/shade6 = .*/shade6 = ${xrdb:color2:#FFCA28}/g' $PDIR/config.ini
sed -i -e 's/shade7 = .*/shade7 = ${xrdb:color2:#FFD54F}/g' $PDIR/config.ini
sed -i -e 's/shade8 = .*/shade8 = ${xrdb:color2:#FFE082}/g' $PDIR/config.ini
